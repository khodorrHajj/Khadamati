                        ...
                        <div class="d-flex justify-content-between align-items-start">
                            <div class="pr-3">
                                ...
                                @if (!empty($notification->data['action_url']))
                                    <form method="POST" action="{{ route('municipality.notifications.read', $notification) }}" data-notification-form data-notification-action data-redirect-url="{{ $notification->data['action_url'] }}">
                                        @csrf
                                        @method('PATCH')
