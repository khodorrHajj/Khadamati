...
@section('title', 'Edit Government Office')
@section('page-title', 'Edit Government Office')

@section('content')
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="card-title mb-0">Edit: {{ $office->name }}</h3>
            <a href="{{ route('admin.offices.show', $office) }}" class="btn btn-secondary btn-sm">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.offices.update', $office) }}">
                ...
                @include('Admin.offices._map_picker', ['mapModel' => $office])
                        ...
                        <tbody>
                            @foreach ($days as $day)
                                @php
                                    ...
                                    $oldStart = old("working_hours.{$day}.start_time", $workingHour->start_time ?? '08:00');
                                    $oldEnd = old("working_hours.{$day}.end_time", $workingHour->end_time ?? '14:00');
                                @endphp
                                <tr>
                ...
                <div class="mt-4">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Update Government Office
                    </button>
                    <a href="{{ route('admin.offices.show', $office) }}" class="btn btn-secondary ml-2">
